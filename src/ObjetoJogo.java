...
public abstract class ObjetoJogo {
    ...
    public boolean colisao(ObjetoJogo outro){  //verifica colisao
        if(!this.ativo || !outro.ativo) return false;  //caso algum nao esteja ativo
        return getBounds().intersects(outro.getBounds());   //se getBounds do objeto intersectar o getBonds do outro, retorna true
    }
